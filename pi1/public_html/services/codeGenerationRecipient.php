...
<html>
    <head>
        ...
        <link href="../styles/aboutDevelopers.css" rel="stylesheet" type="text/css">
        <script>
            var stopwatch = 0;
            var endTime = 0;
            ...
            function start()
            {
                var permissionId = "<?php echo $_POST['permissionId']; ?>";  
                
                document.getElementById("permissionId").value = permissionId;
                generateCode(permissionId);
            ...
            function generateCode(permissionId)
            {
                if (permissionId != null)
                {
                    ...
                    request.open("GET", "setRecipientCode.php?permissionId=" + permissionId, true);
                    request.send();
                }                
            }
	</script>
